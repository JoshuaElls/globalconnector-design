# GlobalConnector Design Partnership Site — Editorial Rules

This repo is the **Design Partnership** version of the Gii site, forked from
`globalconnector-dev` (the **Cost** version). Main-page copy here leads with
early design engagement, quality systems, and dual-region supply; cost-down is
a supporting benefit, not the headline. Keep both sites visually identical
(shared design system) and keep facts consistent between them.

# Editorial rules inherited from the Cost site
